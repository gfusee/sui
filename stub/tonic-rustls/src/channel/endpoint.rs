...
impl Endpoint {
        ...
        D::Error: Into<crate::BoxError>,
    {
        ...
        //TODO Should we provide a default or force users to provide a TLS config?
        // #[cfg(feature = "tls")]
    ...
    #[cfg(feature = "tls")]
    pub fn tls_config(self, tls_config: tokio_rustls::rustls::ClientConfig) -> Result<Self, Error> {
        let domain = self.uri.host().ok_or_else(Error::new_invalid_uri)?;
        let tls_connector =
            TlsConnector::new(tls_config, domain, false).map_err(Error::from_source)?;
