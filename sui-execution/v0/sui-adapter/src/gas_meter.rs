...
impl GasMeter for SuiGasMeter<'_> {
    ...
    fn charge_simple_instr(&mut self, instr: SimpleInstruction) -> PartialVMResult<()> {
        ...
        self.0
            .charge(1, pushes, pops, push_size.into(), pop_size.into(), "".to_string())
    }

    fn charge_pop(&mut self, popped_val: impl ValueView) -> PartialVMResult<()> {
        self.0
            .charge(1, 0, 1, 0, abstract_memory_size(self.0, popped_val).into(), "".to_string())
    }
    ...
    fn charge_native_function(
        ...
        if native_function_threshold_exceeded(self.0.gas_model_version, self.0.num_native_calls) {
            ...
            self.0
                .charge(amount.into(), pushes, 0, size_increase.into(), 0, "".to_string())
        } else {
            // Charge for the stack operations. We don't count this as an "instruction" since we
            // already accounted for the `Call` instruction in the
            // `charge_native_function_before_execution` call.
            self.0.charge(0, pushes, 0, size_increase.into(), 0, "".to_string())?;
            // Now charge the gas that the native function told us to charge.
            self.0.deduct_gas(amount, "".to_string())
        }
    }
    ...
    fn charge_native_function_before_execution(
        ...
        // native call.
        self.0.charge(1, 0, pops, 0, stack_reduction_size.into(), "".to_string())
    }
    ...
    fn charge_ld_const(&mut self, size: NumBytes) -> PartialVMResult<()> {
        ...
        self.0.charge(1, 1, 0, u64::from(size), 0, "".to_string())
    }
    ...
    fn charge_copy_loc(&mut self, val: impl ValueView) -> PartialVMResult<()> {
        ...
        self.0
            .charge(1, 1, 0, abstract_memory_size(self.0, val).into(), 0, "".to_string())
    }
    ...
    fn charge_store_loc(&mut self, val: impl ValueView) -> PartialVMResult<()> {
        ...
        // terms of memory.
        self.0
            .charge(1, 0, 1, 0, abstract_memory_size(self.0, val).into(), "".to_string())
    }
    ...
    fn charge_pack(
        ...
        self.0.charge(1, 1, num_fields, STRUCT_SIZE.into(), 0, "".to_string())
    }
    ...
    fn charge_unpack(
        ...
        let num_fields = args.len() as u64;
        self.0.charge(1, num_fields, 1, 0, STRUCT_SIZE.into(), "".to_string())
    }
    ...
    fn charge_neq(&mut self, lhs: impl ValueView, rhs: impl ValueView) -> PartialVMResult<()> {
        let size_reduction = abstract_memory_size(self.0, lhs) + abstract_memory_size(self.0, rhs);
        self.0
            .charge(1, 1, 2, Type::Bool.size().into(), size_reduction.into(), "".to_string())
    }
    ...
    fn charge_vec_pack<'a>(
        ...
        self.0.charge(1, 1, num_args, VEC_SIZE.into(), 0, "".to_string())
    }

    fn charge_vec_len(&mut self, _ty: impl TypeView) -> PartialVMResult<()> {
        self.0
            .charge(1, 1, 1, Type::U64.size().into(), REFERENCE_SIZE.into(), "".to_string())
    }
    ...
    fn charge_vec_push_back(
        ...
        self.0.charge(1, 0, 2, 0, REFERENCE_SIZE.into(), "".to_string())
    }
    ...
    fn charge_vec_pop_back(
        ...
        self.0.charge(1, 1, 1, 0, REFERENCE_SIZE.into(), "".to_string())
    }
    ...
    fn charge_vec_unpack(
        ...
        self.0.charge(1, pushes, 1, 0, VEC_SIZE.into(), "".to_string())
    }

    fn charge_vec_swap(&mut self, _ty: impl TypeView) -> PartialVMResult<()> {
        let size_decrease = REFERENCE_SIZE + Type::U64.size() + Type::U64.size();
        self.0.charge(1, 1, 1, 0, size_decrease.into(), "".to_string())
    }
